...
ALLOWLIST_REGEX='^(common/src/paths\.rs|cli/src/commands/doctor\.rs|cli/src/commands/doctor/[a-z_]+\.rs|cli/src/commands/uninstall\.rs|cli/src/commands/cache\.rs|cli/src/commands/log\.rs|cli/src/commands/status\.rs|cli/src/main\.rs|cli/src/platforms/mod\.rs)$'
