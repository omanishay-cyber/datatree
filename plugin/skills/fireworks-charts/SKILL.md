...
description: amCharts 5 premium chart integration for Electron + React projects. Gauge, Treemap, Sankey, Funnel, Bar Race, Waterfall, Pie/Donut, Radar, Timeline, Heatmap, Wordcloud. React wrapper patterns with useLayoutEffect + refs. your project glassmorphism theme integration, dark/light mode, CSS variable bridging. Triggers on "gauge", "treemap", "sankey", "funnel", "bar race", "waterfall", "amcharts", "advanced chart", "premium chart", "fireworks-charts", "new chart type", "chart upgrade".
---

# Fireworks Charts — amCharts 5 Premium Integration

> Licensed amCharts 5 integration for Electron + React + TypeScript projects.
> Source: `C:\Users\the user\Downloads\Compressed\amcharts5-master\amcharts5-master\`
...
## your project Theme Integration

### CSS Variable Bridge

amCharts uses its own color system. Bridge your project's CSS variables:

```tsx
function getOrionColor(varName: string): am5.Color {
...
series.set('fill', getOrionColor('--color-primary'));
series.set('stroke', getOrionColor('--color-primary'));
```
...
Wrap amCharts in the your project glass card:
...
**your project use cases:** Gross Margin %, Sales Target %, Expense Ratio
...
// your project business data structure:
const data = {
  name: 'Revenue',
  children: [
    {
...
**your project use cases:** Product category revenue, Vendor spend breakdown, COGS by supplier
...
**your project use cases:** Revenue-to-profit flow, expense allocation, payment method breakdown
...
// your project margin compression funnel:
series.data.setAll([
...
**your project use cases:** Revenue-to-profit funnel, customer conversion pipeline
...
**your project use cases:** Top products by month (race through the year), vendor ranking changes
...
// your project P&L waterfall data:
const data = [
...
## File Organization (your project Pattern)
  ...
  components/
    charts/
      amcharts/
        ...
        orionAmTheme.ts        // CSS variable bridge + your project colors
...
Full amCharts 5 source (v5.16.2) available at:
`C:\Users\the user\Downloads\Compressed\amcharts5-master\amcharts5-master\`

Key directories:
- `src/.internal/charts/` — all chart type implementations
- `src/.internal/core/` — rendering engine, Root, Entity system
- `src/.internal/themes/` — AnimatedTheme, DarkTheme, etc.
- `examples/shared/` — 70+ working examples
